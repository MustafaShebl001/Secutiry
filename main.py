...
# Encryption Section
button_encrypt = tk.Button(frm, text="AES 256 Encrypt", command=on_aes_encrypt_button_click)
button_encrypt.grid(row=2, column=0, pady=20, padx=20)

# Decryption Section
button_decrypt = tk.Button(frm, text="AES 256 Decrypt", command=on_aes_decrypt_button_click)
...
button_cert = tk.Button(frm, text="Generate self-signed cert", command=on_generate_certificate)
button_cert.grid(row=8, column=0, pady=20)

button_verify_cert = tk.Button(frm, text="verify Cert.", command=on_verify_certificate)
button_verify_cert.grid(row=9, column=0, pady=20)
